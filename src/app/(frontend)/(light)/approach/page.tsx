...
export default function ApproachPage() {
  return (
    <div className="appage">
      <section className="ahero"><div className="bg" />
        <div className="wrap">
      ...
      <section className="sec alt"><div className="in">
        ...
        <div className="steps">
          <div className="step"><div className="no">01</div><h3>We ask the questions that matter</h3><p>Group size and composition, ability levels, the kind of holiday you want, the resorts you have skied before and what you loved or didn&rsquo;t.</p></div>
      ...
      <section className="sec alt"><div className="in"><div className="two">
        ...
        <div className="r">
          ...
          <p>An unexpected touch. A gift that arrives without being asked for. An upgrade absorbed rather than charged. A concierge call that goes further than it needed to. These are not gestures — they are the difference between a holiday someone enjoyed and one they talk about for years.</p>
      ...
      <section className="cta"><div className="in">
        ...
        <div>
          ...
          <p>Share your group, your dates and the kind of holiday you have in mind. We&rsquo;ll make a considered recommendation and build the week around it.</p>
