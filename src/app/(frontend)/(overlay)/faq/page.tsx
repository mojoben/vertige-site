...
const CATS: Cat[] = [
  {
    ...
    qas: [
      { q: 'Who are Vertige?', a: <>Vertige is a luxury ski chalet brokerage and concierge. We hand-pick exceptional chalets across the Alps and look after every detail of the stay — from the first enquiry to the last morning on the mountain. Vertige was founded by Ben Wood, whose background in brand and design is matched only by his love of the Alps — and who personally stands behind every chalet on the list.</> },
