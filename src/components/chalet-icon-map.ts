// Icon paths + label→icon mapping for the chalet surfaces. Plain module —
// no 'use client' — so server components (e.g. the /dev/icon-audit page)
// can call pick() too; the rendering components live in ChaletIcons.tsx.
...
export const IC: Record<string, string> = {
 ...
 shower:'<path d="M5 21V6a3 3 0 0 1 3-3h.5a3.5 3.5 0 0 1 3.4 2.7"/><path d="M8.8 9.6a4.3 4.3 0 0 1 8.4 0z"/><path d="M10.3 12.5l-.4 1.4M13.2 12.5v1.4M16 12.5l.4 1.4M11.4 16.2l-.4 1.4M14.8 16.2l.4 1.4"/>',
 ...
 ski:'<path d="M9.3 3.5a1.3 1.3 0 0 1 2.4 1l-5.4 15a1.3 1.3 0 0 1-2.4-1z"/><path d="M14.7 3.5a1.3 1.3 0 0 0-2.4 1l5.4 15a1.3 1.3 0 0 0 2.4-1z"/><path d="M2.5 5v14.5M21.5 5v14.5M1.3 18h2.4M20.3 18h2.4"/>',
 ...
 book:'<path d="M12 6.5C10 4.8 7.3 4.3 4 4.8V18c3.3-.5 6 0 8 1.8 2-1.8 4.7-2.3 8-1.8V4.8c-3.3-.5-6 0-8 1.7z"/><path d="M12 6.5v13.3"/><path d="M2.5 6.8V19c3.8-.6 7 0 9.5 2 2.5-2 5.7-2.6 9.5-2V6.8"/>',
